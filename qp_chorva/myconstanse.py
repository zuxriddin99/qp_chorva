CONSTANCE_CONFIG = {
    ...
    'MAIN_2_uz': ('BIZNING MAHSULOTLAR', 'Header button'),
    ...
    'MAIN_6_uz': ('Bizning mahsulotlar', 'button'),
    ...
    'CATALOG_4_uz': ('Bizning mahsulotlar', 'button'),
    'CATALOG_4_en': ('OUR PRODUCTION', 'button'),
    'CATALOG_5_ru': ('Мы продаём и доставляем', 'selling'),
    'CATALOG_5_uz': ('Biz sotamiz va yetkazib beramiz', 'selling'),
